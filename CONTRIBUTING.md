# Stylist: How to Contribute

## Report Bugs

Report bugs and request enhancement by opening an issue on
[Stylist issues @ Github](https://github.com/MetOffice/stylist/issues).
If reporting a bug, add a recipe for repeating it.
If requesting an enhancement, describe the use case in detail.

## Contribute Code

All contributions to Stylist are made via pull requests against the *master*
branch of [MetOffice/stylist](https://github.com/MetOffice/stylist).
...
(The stylist Contributor Licence Agreement and Certificate of Origin is
